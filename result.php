							...
							<div class="container profile">
						        ...
						        <div class="colors">
						          ...
						          ?>
                                        ...
                                        <p class="profile__status"><?=$vk->status?> </p>
                                        <?php } ?>
									...
									<div class="col-md-9">
										<div class="table_detail">
						                    <table>
						                       ...
						                       <tr class="color">
						                           <td id="time">Пол</td>
						                           <td id="discr" class="centrtable"><?=$vk->sex?></td>
						                           <td><?php checkResultIcon($vk->sex)?></td>
						                        </tr>
						                       <tr> 
						                            <td id="time">Дата рождения</td>
						                            <td id="discr" class="centrtable"><?=$vk->bdate?></td>
						                            <td><?php checkResultIcon($vk->bdate)?></td>
						                        </tr>
						                       <tr>
						                           <td id="time" class="rightable ">Локация</td>
						                           <td id="discr" class="rightable "><?=$vk->city?></td>
						                           <td><?php checkResultIcon($vk->city)?></td>
						                        </tr>
						                        <!-- <tr>
						                           <td id="time" class="rightable ">Телефон</td>
						                           <td id="discr" class="rightable "><?=$vk->phoneNumber?></td>
						                           <td><?php checkResultIcon($vk->phoneNumber)?></td>
						                        </tr> -->
						                        <tr>
						                           <td id="time" class="rightable ">Друзья</td>
						                           <td id="discr" class="rightable "><?=$vk->counterFriends?></td>
						                           <td><?php checkResultIcon($vk->counterFriends)?></td>
						                        </tr>
						                        <tr >
						                           <td id="time" class="rightable ">Посты</td>
						                           <td id="discr" class="rightable "><?=$vk->counterPosts?></td>
						                           <td><?php checkResultIcon($vk->counterPosts)?></td>
						                        </tr>
						                        <tr >
						                           <td id="time" class="rightable ">Фотографии</td>
						                           <td id="discr" class="rightable "><?=$vk->counterAllPhotos?></td>
						                           <td><?php checkResultIcon($vk->counterAllPhotos)?></td>
						                        </tr>
						                        <tr >
						                           <td id="time" class="rightable ">Видеозаписи</td>
						                           <td id="discr" class="rightable "><?=$vk->counterVideos?></td>
						                           <td><?php checkResultIcon($vk->counterVideos)?></td>
						                        </tr>
                                                <tr >
                                                   <td id="time" class="rightable ">Группы</td>
                                                   <td id="discr" class="rightable "><?=$vk->counterGroups?></td>
                                                   <td><?php checkResultIcon($vk->counterGroups)?></td>
                                                </tr>
                                                <tr >
						                ...
						                <div class="table_detail">
						                    <table>
						                       ...
						                       <tr class="color" data-toggle="tooltip" data-placement="top" title="Самооценка человека предполагает оценку им себя в целом и отдельные составляющие своей личности, а именно свои поступки и действия, свои качества и отношения, свою направленность и убеждении и многое другое. Её уровень зависит от как от количества записей на стене, так и от количества загруженных фотографий.">
						                           ...
						                           <td id="discr" class="centrtable"><?=$vk->outStringSelf?></td>
						                        </tr>
